...
void MainMenuScene::Load()
{
	...
	goStartText->AddComponent<dae::TextComponent>()->SetText("A/ENTER to start the Game");
	...
	auto goGamemodeText = std::make_shared<dae::GameObject>(m_MainMenuScene.get());
	goGamemodeText->AddComponent<dae::TextComponent>()->SetText("Gamemode: ");
	goGamemodeText->GetComponent<dae::TextComponent>()->SetFont(pTronFont);
	goGamemodeText->GetComponent<dae::TextComponent>()->SetFontColor(255, 255, 255);
	goGamemodeText->AddComponent<dae::TransformComponent>()->SetPosition(50.f, 500.f, 0.f);
	...
	auto goToNextSceneGP = std::make_unique<dae::GoToNextSceneCommand>(goNextScene.get());
	auto changeModeCommand = std::make_unique<dae::ChangeModeCommand>(goGamemode.get(), m_Gamemodes);
	auto changeModeCommandGP = std::make_unique<dae::ChangeModeCommand>(goGamemode.get(), m_Gamemodes);
	...
	input.BindCommandController(0, dae::XBox360Controller::ControllerButton::Y, std::move(changeModeCommandGP), 1);
	input.BindCommandController(0, dae::XBox360Controller::ControllerButton::A, std::move(goToNextSceneGP), 1);
